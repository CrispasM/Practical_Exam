...
//   return (
//     <>
//       <Typography variant="h4" component="h1" gutterBottom>MHFR Facilities</Typography>
//       <SearchFilter search={search} handleSearch={handleSearch} />
//       <FacilityList facilities={filteredFacilities} districts={districts} owners={owners} />
//     </>
//   );
// };
...
//     const fetchData = async () => {
//       try {
//         const facilitiesResponse = await axios.get<Facility[]>(
...
//         );
//         const ownersResponse = await axios.get<Owner[]>(
